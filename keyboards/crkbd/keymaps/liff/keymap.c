...
#include "shortcuts_on.h"
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
     _______, KC_BTN2,   _F7   ,  _F8   ,  _F9   , _F10   ,                      TO(4),   TO(8) , KC_LALT, KC_RCTL, KC_RSFT, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                         XXXXXXX,   ENT,    MO(9),      MO(10),   SPC,   XXXXXXX
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
     _______,   GRV,     AMP,     EXL,     DLR,     TIL,                          AST,     PLS,     MNS,     EQL,     BSL,   _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______, LGT(LSQ),LAT(LBR),LCT(LCB),LST(LPR),  PIP,                          CIR,   RST(RPR),RCT(RCB),LAT(RBR),LGT(COL),_______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     _______, US_RSQU,   PRC,     HSH,   US_EURO,   AT,                           DQT,     UND,    KC_LT,   KC_GT,    QUE,   _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                         _______, _______, _______,    _______, _______, _______
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
     _______, DT_PRNT,    _7,      _8,      _9,      _0,                         OSL(7), KC_HOME, KC_PGDN, KC_PGUP,  KC_END, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    state = update_tri_layer_state(state, 9, 10, 11);
    return state;
}
